...
$rows=$db->select("select * from videos where id=".$_GET['id']);
?>
...
<div class="main">
	<div class="content new-user">
		...
		{
		?>
			<div class="msg" style="display: block"><span>Video has been modified successfully!</span></div>
		<?php
		}else{
		?>
		...
		<div class="form">
			<form method="post" onsubmit="return validateMe();"  enctype="multipart/form-data" >
				...
				<textarea name="video_code" required  ><?=$rows[0]["video_code"]?></textarea>
