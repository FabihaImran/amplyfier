  ...
  <?php include("header.php"); ?>
    ...
    <div class="container">
        ...
        <div class="video-grid">
            <?php
            $rows=$db->select("select a.*,b.artist_name,c.album_title from videos a left join artists b on b.id=a.artist_id left join albums c on c.id=a.album_id where a.media_type='audio' order by ts desc");
